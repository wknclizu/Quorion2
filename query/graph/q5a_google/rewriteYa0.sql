create temp table g3 as select google.src as v4, google.dst as v6, v14 from google, (SELECT src, COUNT(*) AS v14 FROM google GROUP BY src) AS c2 where google.dst = c2.src;
create temp table semiUp6097769221023935676 as select src as v2, dst as v4 from google AS g2 where (dst) in (select v4 from g3);
create temp table g5 as select google.src as v4, google.dst as v10, v18 from google, (SELECT dst, COUNT(*) AS v18 FROM google GROUP BY dst) AS c4 where google.dst = c4.dst;
create temp table semiUp8957944261393458998 as select v2, v4 from semiUp6097769221023935676 where (v4) in (select v4 from g5);
create temp table g4 as select google.src as v7, google.dst as v2, v16 from google, (SELECT dst, COUNT(*) AS v16 FROM google GROUP BY dst) AS c3 where google.src = c3.dst and v16<3;
create temp table semiUp6286286585764294953 as select v2, v4 from semiUp8957944261393458998 where (v2) in (select v2 from g4);
create temp table g1 as select google.src as v1, google.dst as v2, v12 from google, (SELECT src, COUNT(*) AS v12 FROM google GROUP BY src) AS c1 where google.src = c1.src and v12<3;
