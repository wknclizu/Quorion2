create or replace view aggView5455802152684778280 as select p_partkey as v6, p_size as v11, p_brand as v9, p_type as v10 from part as part where p_brand<> 'Brand#45' and p_type NOT LIKE 'MEDIUM POLISHED%' and p_size not IN (49);
