create or replace view aggView5455802152684778280 as select p_partkey as v6, p_size as v11, p_brand as v9, p_type as v10 from part as part where p_size between 39 and 50;
