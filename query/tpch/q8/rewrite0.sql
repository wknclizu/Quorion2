create or replace view aggView8912447183208614737 as select r_regionkey as v53 from region as region;
...
create or replace view aggView847688974884380445 as select p_partkey as v1 from part as part;
