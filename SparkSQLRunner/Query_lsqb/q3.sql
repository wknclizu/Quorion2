SELECT count(*)
FROM City AS CityA, City AS CityB, City AS CityC, lPersonl AS PersonA, lPersonl AS PersonB, lPersonl AS PersonC, qPerson_knows_PersonR AS pkp1, qPerson_knows_PersonR AS pkp2, qPerson_knows_PersonR AS pkp3
