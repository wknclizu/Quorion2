...
create or replace TEMP view g2 as select google.src as v2, google.dst as v4, v12 from google, (SELECT src, COUNT(*) AS v12 FROM google GROUP BY src) AS c3 where google.src = c3.src;
...
create or replace TEMP view g3 as select google.src as v4, google.dst as v9, v10, v14 from google, (SELECT src, COUNT(*) AS v10 FROM google GROUP BY src) AS c2, (SELECT dst, COUNT(*) AS v14 FROM google GROUP BY dst) AS c4 where google.dst = c2.src and google.dst = c4.dst;
